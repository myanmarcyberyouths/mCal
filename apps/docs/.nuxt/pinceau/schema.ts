          ...
          sm: {
            ...
            properties: {
              value: {
                ...
                default:
                  "0px 1px 3px 0px {color.shadow}, 0px 1px 2px -1px {color.shadow}",
              },
            },
            type: "object",
            default: {
          ...
          md: {
            ...
            properties: {
              value: {
                ...
                default:
                  "0px 4px 6px -1px {color.shadow}, 0px 2px 4px -2px {color.shadow}",
              },
            },
            type: "object",
            default: {
          ...
          lg: {
            ...
            properties: {
              value: {
                ...
                default:
                  "0px 10px 15px -3px {color.shadow}, 0px 4px 6px -4px {color.shadow}",
              },
            },
            type: "object",
            default: {
          ...
          xl: {
            ...
            properties: {
              value: {
                ...
                default:
                  "0px 20px 25px -5px {color.shadow}, 0px 8px 10px -6px {color.shadow}",
              },
            },
            type: "object",
            default: {
