export const theme = {
  ...
  shadow: {
    ...
    sm: {
      value:
        "0px 1px 3px 0px var(--color-shadow), 0px 1px 2px -1px var(--color-shadow)",
      variable: "var(--shadow-sm)",
      raw: "0px 1px 3px 0px {color.shadow}, 0px 1px 2px -1px {color.shadow}",
    },
    md: {
      value:
        "0px 4px 6px -1px var(--color-shadow), 0px 2px 4px -2px var(--color-shadow)",
      variable: "var(--shadow-md)",
      raw: "0px 4px 6px -1px {color.shadow}, 0px 2px 4px -2px {color.shadow}",
    },
    lg: {
      value:
        "0px 10px 15px -3px var(--color-shadow), 0px 4px 6px -4px var(--color-shadow)",
      variable: "var(--shadow-lg)",
      raw: "0px 10px 15px -3px {color.shadow}, 0px 4px 6px -4px {color.shadow}",
    },
    xl: {
      value:
        "0px 20px 25px -5px var(--color-shadow), 0px 8px 10px -6px var(--color-shadow)",
  ...
  prose: {
    ...
    th: {
      ...
      padding: {
        value:
          "0 var(--typography-verticalMargin-sm) var(--typography-verticalMargin-sm) var(--typography-verticalMargin-sm)",
