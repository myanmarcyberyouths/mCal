...
const LanguageMenu = ({ selectedLanguage, onLanguageChange }: LanguageMenuProps) => {
  return (
    <Menu
      as="div"
      className="relative">
      ...
      <Transition
        ...
        <Menu.Items className="absolute right-0 z-10 mt-3 w-36 origin-top-right overflow-hidden rounded-md bg-gray-0 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            <Menu.Item>
              {({ active }) => (
                <a
