...
function Calendar() {
  ...
  return (
    <section
      aria-label="Calendar"
      className={cn(
        "flex-1 h-[calc(100vh-theme(spacing.nav-h))] supports-[height:100cqh]:h-[calc(100cqh-theme(spacing.nav-h))] supports-[height:100svh]:h-[calc(100svh-theme(spacing.nav-h))] border-l  border-cgray-300 __scrollbar-md"
      )}>
