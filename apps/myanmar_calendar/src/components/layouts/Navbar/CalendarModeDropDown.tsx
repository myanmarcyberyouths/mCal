...
function CalendarModeDropDown() {
  ...
  return (
    <>
      ...
      >
        <div>
          <Menu.Button className="inline-flex  w-full justify-center  rounded-md px-4 py-2 text-sm font-medium capitalize text-gray-600 border border-1 border-gray-250 hover:bg-gray-50">
        ...
        >
          <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-gray-0 shadow-lg ring-1 focus:outline-none ring-black/5 dark:bg-gray-75">
