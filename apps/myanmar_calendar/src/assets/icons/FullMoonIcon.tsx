...
const FullMoonIcon = ({...props}: FullMoonIconProps) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48" {...props}>
            ...
            <path fill="#eb7900"
                  d="M35.984,8.016C38.495,11.358,40,15.498,40,20c0,11.046-8.954,20-20,20	c-4.502,0-8.642-1.505-11.984-4.016C11.664,40.843,17.456,44,24,44c11.046,0,20-8.954,20-20C44,17.456,40.843,11.664,35.984,8.016z"></path>
