...
const dayDefination = {
  ...
  amyeittasote:
    "ဘယ်ကိစ္စ မဆို အမြိတ္တစုတ် ရက်မှာ ဆောင်ရွက်ရင် ပြဿဒါး၊ ဝါရမိတ္တု၊ ရက်ကြမ်း ဘယ်လောက် အဆိုးကြုံကြုံ ပြီးစီး အောင်မြင်နိုင်တယ်။ အမြိတ္တစုတ် ရက်က ရက်တစ်ရက်ရဲ့ အဆိုး၊ အပြစ် အားလုံး ကြေပျက်စေတယ်။ မကောင်းတဲ့ အခိုက်အညံ့ အားလုံး ဖယ်ရှားပေးတယ် လို့ဆိုပါတယ်",
...
function သင်္ကြန်ချိတ်တွက်ရန်(မြန်မာခုနှစ်) {
  ...
  var ja = SY * မြန်မာခုနှစ် + MO;
  if (မြန်မာခုနှစ် >= SE3) jk = ja - 2.169918982;
  else jk = ja - 2.1675;
...
*/
export function engToMm(year, month, date) {
  let mmDate = {
    year: 0,
    month: "",
    moonPhase: "",
...
*/
export function mmToEng(year, month, monthType, moonPhase, date) {
  let engDate = {
    year: 0,
    month: "",
    date: "",
